        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    spanishMnemonic = 'avance colmo poema momia cofre pata res verso secta cinco tubería yacer eterno observar ojo tabaco seta ruina bebé oral miembro gato suelo violín';
                    expectedPrivateKeys = [
                        {
                            derivation0: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    mnemonic = account_1.formatNonAccentedCharacters(mnemonic);
                    expect(account_1.validateMnemonic(mnemonic)).toBeTruthy();
                    return [4 /*yield*/, account_1.generateKeys(mnemonic)];
                case 2:
                    derivation0 = _a.sent();
                    return [4 /*yield*/, account_1.generateKeys(mnemonic, undefined, 0, 1)];
                case 3:
                    derivation1 = _a.sent();
