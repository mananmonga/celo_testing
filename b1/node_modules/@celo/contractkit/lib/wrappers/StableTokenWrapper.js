            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        config = _a.sent();
                        inflationParameters = {
                            updatePeriod: BaseWrapper_1.secondsToDurationString(config.inflationParameters.updatePeriod),
                            factorLastUpdated: BaseWrapper_1.unixSecondsTimestampToDateString(config.inflationParameters.factorLastUpdated),
                        };
